...
/*if (["6307319492625275", "4649044778518083", "25932607893050441"].includes(t)) return;*/
...
/*if(s === "100092754290822") {
return r("You are permanently banned from using this ai");
}*/
    var p = a.slice(1);
...
async function ai(prompt, id, name, system, gender) {
  const post = (p, m = "llama3-70b-8192") => axios.post("https://api-v2-2.onrender.com/g4o", { id, prompt: p, name, model: m, system, gender });  
  try {
